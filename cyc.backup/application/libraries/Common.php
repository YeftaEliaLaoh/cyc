		...
		// Load PHPMailer library
		 ...
		 // $this->load->library('parser');
		  ...
		  // konfigurasi login smtp
		   $mail->Username = 'test@dev.andtechnology.me';                            // SMTP username
		   $mail->Password = 'm*;O;ZtJ^0uj';  
			
		   $mail->setFrom('test@dev.andtechnology.me', 'CYC Forgot Password');
		  ...
		  //$message = $this->parser->parse("email/$template", $msg);
		  $message = $msg;
