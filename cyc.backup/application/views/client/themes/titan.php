...
<?php endif; ?>
 ...
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC8wTfFuny5VqqdD1J-PQ9r_2auV7_huJY&libraries=places"></script>
    ...
    <div id="footer" class="clearfix">
      <span class="pull-left"><?php echo lang("ctn_170") ?> <a href="http://deratech.id/">Deratech</a> - <?php echo $this->settings->info->site_name ?> V<?php echo $this->settings->version ?> - <a href="<?php echo site_url("home/change_language") ?>"><?php echo lang("ctn_171") ?></a></span>
    </div>
