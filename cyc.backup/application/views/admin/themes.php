...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <input type="button" class="btn btn-primary btn-sm" value="<?php echo "Add Themes" ?>" data-toggle="modal" data-target="#addModal" />
</div>
</div>
...
<ol class="breadcrumb">
  ...
  <li class="active"><?php echo lang("ctn_171_2") ?></li>
</ol>

<div class="table-responsive">
<table id="page-table" class="table table-striped table-hover table-bordered">
<thead>
<tr class="table-header"><td><?php echo lang("ctn_81") ?></td><td><?php echo lang("ctn_271_1") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#page-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("admin/themes_page") ?>",
            type : 'GET',
            data : function ( d ) {
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo "Add Themes"; ?></h4>
      </div>
      <div class="modal-body">
      <?php echo form_open(site_url("admin/add_themes"), array("class" => "form-horizontal")) ?>
            <div class="form-group">
             ...
             <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="email-in" name="color">
                    </div>
            </div>
