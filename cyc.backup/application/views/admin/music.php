...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <input type="button" class="btn btn-primary btn-sm" value="<?php echo "Add music"; ?>" data-toggle="modal" data-target="#addModal" />
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_81") ?></td><td>Artist</td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#page-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("admin/music_page") ?>",
            type : 'GET',
            data : function ( d ) {
...
function set_search_icon(icon, options) 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(site_url("admin/add_music"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="artist-in" name="artist">
                    </div>
            </div>
            ...
            <div class="form-group">
                <label for="userfil2" class="col-sm-3 label-heading">Music</label>
                <div class="col-sm-9">
