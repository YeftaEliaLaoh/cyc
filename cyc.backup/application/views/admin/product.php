...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <input type="button" class="btn btn-primary btn-sm" value="<?php echo "Add product"; ?>" data-toggle="modal" data-target="#addModal" />
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_81") ?></td><td>Description</td><td>Price</td><td>Category</td><td>Seller</td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#page-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("admin/product_page") ?>",
            type : 'GET',
            data : function ( d ) {
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo "Add Page Product" ?></h4>
      </div>
      <div class="modal-body">
      <?php echo form_open_multipart(site_url("admin/add_product"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="price-in" name="price">
                    </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                    <label for="price-in" class="col-md-3 label-heading">Category</label>
                    <div class="col-md-9">
            ...
            <div class="form-group">
                    <label for="price-in" class="col-md-3 label-heading">Seller</label>
                    <div class="col-md-9">
