...
<div class="form-group">
            ...
            <div class="form-group">
            <label for="type-in" class="col-md-3 label-heading"><?php echo "Type Post / Thread"; ?></label>
                    <div class="col-md-9">
                        <select name="type" class="form-control" id="type">
                          <option value="0" <?php if($category->type == 0) { echo "selected='selected'"; } ?>>Post</option>
                          <option value="1" <?php if($category->type == 1) { echo "selected='selected'"; } ?>>Thread</option>
                        </select>
                    </div>
            </div>
