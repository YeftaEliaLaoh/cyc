...
<?php endif; ?>
    ...
    <div id="footer" class="clearfix">
      <span class="pull-left"><?php echo lang("ctn_170") ?> <a href="http://deratech.id/" rel="nofollow">Deratech</a> <?php echo $this->settings->info->site_name ?> V<?php echo $this->settings->version ?></span> <span class="pull-right"><a href="<?php echo site_url("home/change_language") ?>"><?php echo lang("ctn_171") ?></a></span>
    </div>
