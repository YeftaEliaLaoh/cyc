...
class Page_Model extends CI_Model 
{
	...
	public function get_list_music($name,$artist) {
		$qry = $this->db->query("SELECT * FROM music WHERE name LIKE '%$name%' OR artist LIKE '%$name%'")->result();
		return $qry;
	}
	...
	public function get_log_visitor($userid,$limit = 10,$page = 0) {
		...
		WHERE pageid = $userid GROUP BY userid LIMIT $page,$limit");
	}
