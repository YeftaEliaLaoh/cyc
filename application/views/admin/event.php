...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <input type="button" class="btn btn-primary btn-sm" value="<?php echo "Add event"; ?>" data-toggle="modal" data-target="#addModal" />
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_81") ?></td><td>Description</td><td>Region</td><td>Date & Time</td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#page-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("admin/event_page") ?>",
            type : 'GET',
            data : function ( d ) {
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo "Add Page City" ?></h4>
      </div>
      <div class="modal-body">
      <?php echo form_open_multipart(site_url("admin/add_event"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                    <label for="location-in" class="col-md-3 label-heading">Location Name</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="location-in" name="location">
                    </div>
            </div>
            <div class="form-group">
                    <label for="price-in" class="col-md-3 label-heading">Date & Time</label>
                    <div class="col-md-9">
                      <input type="text" class="form-control datetimepicker" name="timestamp" id="timestamp">
                    </div>
            </div>
