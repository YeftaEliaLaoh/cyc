...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <input type="button" class="btn btn-primary btn-sm" value="<?php echo "Add Provinces"; ?>" data-toggle="modal" data-target="#addModal" />
</div>
</div>
   ...
   var st = $('#search_type').val();
    var table = $('#page-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("admin/provinces_page") ?>",
            type : 'GET',
            data : function ( d ) {
...
function set_search_icon(icon, options) 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("admin/add_provinces"), array("class" => "form-horizontal")) ?>
