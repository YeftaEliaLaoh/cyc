...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <input type="button" class="btn btn-primary btn-sm" value="<?php echo "Add Seller"; ?>" data-toggle="modal" data-target="#addModal" />
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_81") ?></td><td>Description</td><td>Phone</td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#page-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("admin/seller_page") ?>",
            type : 'GET',
            data : function ( d ) {
...
function set_search_icon(icon, options) 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("admin/add_seller"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="phone-in" name="phone">
                    </div>
            </div>
            <div class="form-group">
