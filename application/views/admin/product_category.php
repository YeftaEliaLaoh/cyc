...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <input type="button" class="btn btn-primary btn-sm" value="<?php echo "Add Product Category"; ?>" data-toggle="modal" data-target="#addModal" />
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_81") ?></td><td>Description</td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#page-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("admin/product_category_page") ?>",
            type : 'GET',
            data : function ( d ) {
...
function set_search_icon(icon, options) 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(site_url("admin/add_product_category"), array("class" => "form-horizontal")) ?>
